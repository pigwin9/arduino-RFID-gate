    ...
    <main className="min-h-screen bg-gray-100 p-8 text-black">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-6">
        <div className="flex justify-between items-start mb-4">
          <div>
            <h1 className="text-3xl font-bold">👋 Witaj w panelu zarządzania</h1>
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          <div className="bg-white rounded-xl px-6 py-4 shadow flex justify-between items-center gap-2 w-full">
            <div><span className="text-xl">👤</span> Kacper Tąpolski</div>
            <div>
              <button 
          ...
          <div className="bg-white rounded-xl px-6 py-4 shadow flex justify-between items-center gap-2 w-full">
            <div><span className="text-xl">👤</span> Jakub Sinkiewicz</div>
            <div>
          ...
          <div className="bg-white rounded-xl px-6 py-4 shadow flex justify-between items-center gap-2 w-full">
            <div><span className="text-xl">👤</span> Maciej Sobiś</div>
            <div>
              <button className="bg-gray-400 text-white px-3 py-2 rounded hover:bg-gray-500 mr-1 cursor-pointer transition">
                Zarządzaj odbiciami
              </button>
